...
export class AccountsManagerPanel {
  public static currentPanel: AccountsManagerPanel | undefined;

  public static readonly viewType = "AccountsManager";
  ...
  public static createOrShow(extensionUri: vscode.Uri) {
    ...
    const panel = vscode.window.createWebviewPanel(
      AccountsManagerPanel.viewType,
      "Accounts Manager",
      column || vscode.ViewColumn.One,
      getWebviewOptions(extensionUri)
    );

    AccountsManagerPanel.currentPanel = new AccountsManagerPanel(
      panel,
      extensionUri
    );
  }
