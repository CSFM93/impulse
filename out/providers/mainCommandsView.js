...
exports.treeDataProvider = exports.MainCommandsView = void 0;
const vscode = require("vscode");
let _extensionUri;
class MainCommandsView {
    constructor(context) {
        _extensionUri = context.extensionUri;
        vscode.window.registerTreeDataProvider("impulse.mainCommandsView", treeDataProvider());
        const view = vscode.window.createTreeView('impulse.mainCommandsView', { treeDataProvider: treeDataProvider(), showCollapseAll: true });
        context.subscriptions.push(view);
    }
}
exports.MainCommandsView = MainCommandsView;
const tree = {
    'test': {
        label: "Test",
        iconName: "flask.png",
...
//# sourceMappingURL=mainCommandsView.js.map