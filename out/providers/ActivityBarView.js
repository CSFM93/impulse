...
exports.treeDataProvider = exports.ActivityBarView = void 0;
const vscode = require("vscode");
let _extensionUri;
class ActivityBarView {
    constructor(context) {
        _extensionUri = context.extensionUri;
        vscode.window.registerTreeDataProvider("impulse.activitybarView", treeDataProvider());
        const view = vscode.window.createTreeView('impulse.activitybarView', { treeDataProvider: treeDataProvider(), showCollapseAll: true });
...
//# sourceMappingURL=ActivityBarView.js.map